...
transforming...
[32mG£ô[39m 39 modules transformed.
rendering chunks...
computing gzip size...
[2mdist/[22m[32mindex.html                 [39m[1m[2m  0.68 kB[22m[1m[22m[2m Göé gzip:  0.39 kB[22m
[2mdist/[22m[35massets/index-Bwy9EhVx.css  [39m[1m[2m 43.79 kB[22m[1m[22m[2m Göé gzip:  9.09 kB[22m
[2mdist/[22m[36massets/index-BUGzLbAn.js   [39m[1m[2m208.41 kB[22m[1m[22m[2m Göé gzip: 60.99 kB[22m
[32mG£ô built in 1.03s[39m
```
...
=ƒ¢ín+Å Starting Safety Guardrails Verification Scanner...
...
==================================================
G£à Safety Verification PASSED. No forbidden patterns detected in code/configs.
```
## 3. Docker Build
```
...
#15 5.781 G£ô 39 modules transformed.
#15 5.972 rendering chunks...
#15 5.982 computing gzip size...
#15 5.992 dist/index.html                   0.68 kB Göé gzip:  0.39 kB
#15 5.992 dist/assets/index-Bwy9EhVx.css   43.79 kB Göé gzip:  9.09 kB
#15 5.993 dist/assets/index-BUGzLbAn.js   208.41 kB Göé gzip: 60.99 kB
#15 5.994 G£ô built in 1.38s
#15 DONE 6.4s
...
qsight-prototype-api       infra-api                "docker-entrypoint.sGÇª"   api        27 seconds ago   Up 15 seconds             0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp
qsight-prototype-postgis   postgis/postgis:15-3.3   "docker-entrypoint.sGÇª"   postgres   27 seconds ago   Up 26 seconds (healthy)   0.0.0.0:5432->5432/tcp, [::]:5432->5432/tcp
qsight-prototype-web       infra-web                "/docker-entrypoint.GÇª"   web        27 seconds ago   Up 15 seconds             0.0.0.0:5173->8080/tcp, [::]:5173->8080/tcp
```
